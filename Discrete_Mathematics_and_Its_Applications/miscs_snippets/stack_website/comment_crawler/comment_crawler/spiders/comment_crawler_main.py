...
class CommentCrawlerMainSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for target_file in target_files:
          ...
          urls = urls + [re.search(self.url_pattern,line) for line in open(target_file)]
    ...
    def parse(self, response, origin_url):
        ...
        id = id_group.group(1) if (id_group:=re.search(self.url_pattern[2:],origin_url)) is not None else 0
        if id == 0:
