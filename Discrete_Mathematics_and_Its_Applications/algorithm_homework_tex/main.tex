...
\newcommand{\ModProcNameAndLabelSuffix}[2]{
    ...
    % \let\Suffix3suf %
    \renewcommand{\AlgLabel}{\expandafter\CurTodolistToplevelIndex#2}
    \show\AlgLabel
    \renewcommand{\AlgorithmRef}{\text{ See }\hyperref[alg:\AlgLabel]{the pseudocode}}
}
...
%     % \ModProcNameAndLabelSuffix{finds the maximum and minimum of a sequence}{\textunderscore3\textunderscore supplementary}
