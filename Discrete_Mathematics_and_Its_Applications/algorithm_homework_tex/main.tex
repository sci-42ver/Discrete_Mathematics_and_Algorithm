...
% \NewCommandCopy{\Suffix}{\AlgLabel}
% \RenewCommandCopy{\Suffix}{-23}
% \let\Suffix\AlgLabel
\newcommand{\Suffix}{_default}
\renewcommand{\Suffix}{_default_default}
% \NewCommandCopy{\oldAlgLabel}{\AlgLabel}
...
\newcommand{\ModProcName}[1]{
    ...
    % \item \let\Suffix\AlgLabel % here will cause the infinite loop
    % \item \RenewCommandCopy{\Suffix}{\AlgLabel} % here will cause the infinite loop
...
% https://tex.stackexchange.com/a/442187/308105
\makeatletter
  ...
  \clist_map_inline:nn { #1 }
   {
    ...
    % ## https://www.alanshawn.com/latex3-tutorial/#handle-macro-expansion-like-a-boss
...
\newcommand{\ForRangeBy}[5]{%
    % https://www.overleaf.com/learn/latex/Spacing_in_math_mode
    \For{#1\,\(\coloneqq#2\;\)\KwTo \(#3\)\By #5}{ #4}
}
\DontPrintSemicolon
