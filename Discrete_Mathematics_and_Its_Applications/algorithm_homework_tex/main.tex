...
\SetKwFor{For}{for }{}{}
% \SetKwIF{If}{ElseIf}{Else}{if}{then\vspace{3pt}}{else if}{else}{endif}
...
% here \@gobble consumes the leading (TODO why it doesn't exist for single/double quote)`
% https://tex.stackexchange.com/a/85807/308105
